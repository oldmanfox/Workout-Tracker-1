    ...
    if ([week isEqualToString:@"Week 10"]) {
        ...
        if (indexPath.section == 0) {
            ...
            if (indexPath.row == 0) {
                ...
                // Cardio X 15
                ((DataNavController *)self.parentViewController).index = [NSNumber numberWithInt:15];
            }
            ...
            if (indexPath.row == 0) {
                ...
                // Cardio X 16
                ((DataNavController *)self.parentViewController).index = [NSNumber numberWithInt:16];
            }
            ...
            if (indexPath.row == 0) {
                ...
                // Cardio X 17
                ((DataNavController *)self.parentViewController).index = [NSNumber numberWithInt:17];
            }
    ...
    // Week 12
        ...
        if (indexPath.section == 0) {
            ...
            if (indexPath.row == 0) {
                ...
                // Cardio X 22
                ((DataNavController *)self.parentViewController).index = [NSNumber numberWithInt:22];
            }
            ...
            if (indexPath.row == 0) {
                ...
                // Cardio X 23
                ((DataNavController *)self.parentViewController).index = [NSNumber numberWithInt:23];
            }
            ...
            if (indexPath.row == 0) {
                ...
                // Cardio X 24
                ((DataNavController *)self.parentViewController).index = [NSNumber numberWithInt:24];
            }
            ...
            if (indexPath.row == 0) {
                ...
                // Cardio X 25
                ((DataNavController *)self.parentViewController).index = [NSNumber numberWithInt:25];
            }
