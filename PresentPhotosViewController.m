...
- (void)emailPhotos
{
    ...
    if ([MFMailComposeViewController canSendMail]) {
        ...
        if ([self.navigationItem.title isEqualToString:@"All"]) {
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT 1 All Photos - Session %@", currentSessionString];
        ...
        // FRONT PHOTOS
            ...
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT 1 Front Photos - Session %@", currentSessionString];
            [mailComposer setSubject:emailTitle];
        ...
        // SIDE PHOTOS
            ...
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT 1 Side Photos - Session %@", currentSessionString];
            [mailComposer setSubject:emailTitle];
        ...
        // BACK PHOTOS
            ...
            NSString *emailTitle = [NSString stringWithFormat:@"90 DWT 1 Back Photos - Session %@", currentSessionString];
            [mailComposer setSubject:emailTitle];
