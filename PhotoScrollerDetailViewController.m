...
- (void)viewDidLoad
{
    ...
    self.picAngle = @"Front";
    self.picTitle = [((PhotoNavController *)self.parentViewController).month stringByAppendingFormat:@" %@", self.picAngle];
    
    // Load image from application documents directory.
    PhotoNavController *photoNC = [[PhotoNavController alloc] init];
    self.displayImageView.image = [photoNC loadImage:self.picTitle];
}
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    dispatch_async(saveQueue, ^{
        ...
        [photoNC saveImage:scaledImage imageName:self.picTitle];
