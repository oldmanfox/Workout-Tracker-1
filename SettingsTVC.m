...
- (void)configureButtonBorder {
    ...
    UIColor *blue = [UIColor colorWithRed:0/255.0f green:122/255.0f blue:255/255.0f alpha:1.0f];
    UIColor *lightBlue = [UIColor colorWithRed:0/255.0f green:122/255.0f blue:255/255.0f alpha:0.75f];
...
- (void)findiCloudStatus {
    ...
    if ([CoreDataHelper sharedHelper].iCloudEnabledByUser) {
        ...
        self.iCloudAppStatusLabel.text = @"NO.  Change in Device Settings -> 90 DWT 1";
    }
}
